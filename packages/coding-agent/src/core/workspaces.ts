...
export interface WorkspaceResourceLoaderOverridesOptions {
	includeContextFiles?: boolean;
}

export function createWorkspaceResourceLoaderOverrides(
	workspaceController: Pick<WorkspaceController, "getActive">,
	options: WorkspaceResourceLoaderOverridesOptions = {},
): {
	...
	return {
		agentsFilesOverride: (base) => {
			...
			if (!activeWorkspace || !includeContextFiles) {
				return base;
			}
